...
function StatCard({ label, value, color }) {
  return (
    <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 10, padding: '18px 22px', flex: 1, minWidth: 140 }}>
      ...
      <div className="stats-value" style={{ fontSize: 28, fontWeight: 800, color }}>{value}</div>
    </div>
  )
}
...
export default function Dashboard({ clients, onMeetingSave, onClientClick }) {
  ...
  return (
    <div className="page-padding" style={{ padding: 40 }}>
      ...
      <div className="page-subtitle" style={{ color: 'var(--muted)', fontSize: 14, marginBottom: 28, fontFamily: 'var(--mono)' }}>// Panel główny — zarządzanie klientami i spotkaniami</div>

      <div className="stats-row" style={{ display: 'flex', gap: 14, marginBottom: 28, flexWrap: 'wrap' }}>
